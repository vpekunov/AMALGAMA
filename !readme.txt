...
для программы AirEcology-P. Также сущетвует в виде отдельного
программного продукта PGEN++ (в настоящее время известна под новым
названием АМАЛЬГАМА).

  Подсистема подробно описана в книге
...
образования и распространения загрязнений. Используется технология
...
учесть тот или иной фактор) в конкретные части модели.
  Здесь представлена полная версия (PGEN++/АМАЛЬГАМА) подсистемы, которая также
умеет решать ряд обратных задач, связанных с распознаванием смысла текстов
и программ. В частности, можно реконструировать описание исходной модели
по порожденной программе (реализовано в некоторых учебных примерах) или по
...
один из xml-файлов с описаниями моделей:
